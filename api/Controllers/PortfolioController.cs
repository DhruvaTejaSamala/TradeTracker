        ...
        public async Task<IActionResult> AddPortfolio(string symbol)
        {
            ...
            if(stock == null)
            {
                ...
                if(stock != null)
                {
                   ...
                   return BadRequest("The stock doesn't exist in FMP");
                   //return StatusCode(stock);
                }
            }
            ...
            if(userPortfolio.Any(e => e.Symbol.ToLower() == symbol.ToLower())) return BadRequest("Cannot add same stock to potfolio");
